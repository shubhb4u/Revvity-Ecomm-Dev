...
import getQuotePdfDownloadUrl from '@salesforce/apex/QuotePdfDownloadApi.getQuotePdfDownloadUrl';
...
export default class Ecom_quoteHeaderStrip extends LightningElement {
    ...
    async handleDownload() {
        try { 
            ...
            // Open the returned relative URL (works in Lightning/Experience Cloud for authenticated users)
